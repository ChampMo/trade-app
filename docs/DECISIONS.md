...
| D13 | 2026-09-02 | เวลาใน journal เป็น **UTC** ทั้งหมด (naive UTC ใน SQLite) · เก็บ offset ของ server โบรกไว้ด้วย · UI แสดงเวลาไทยได้แต่ตารางคง UTC | MT5 ใช้เวลา server ไม่ใช่ UTC ไม่ใช่เวลาไทย |
